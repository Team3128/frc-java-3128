...
public class HolonomicDrive
{
    ...
    public void steer()
    {
    	...
    	double joyX = _listenerManager.getRawDouble(ListenableXbox.JOY1X);
    	double joyY = _listenerManager.getRawDouble(ListenableXbox.JOY1Y);
    	...
    	double joyTurn = _listenerManager.getRawDouble(ListenableXbox.JOY2X);
