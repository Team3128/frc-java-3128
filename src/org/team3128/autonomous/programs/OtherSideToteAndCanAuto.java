...
public class OtherSideToteAndCanAuto  extends CommandGroup
{
    public OtherSideToteAndCanAuto()
    {
    	addSequential(new CmdArmAngles(46+15, 280, 11, 5000));//81
    	addSequential(new CmdDelay(1500));
    	
    	addSequential(new CmdLog("Opening Claw"));
    	addSequential(new CmdOpenClaw(1400));
    	addSequential(new CmdArmAngles(46+25, 145, 10, 7500));//81
    	addSequential(new CmdDelay(4000));
    	
    	addSequential(new CmdLog("Driving To Can"));
    	addSequential(new CmdMoveForward(27+13, 2000));
